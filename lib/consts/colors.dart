...
class ColorsConsts{
  ...
  static Color cartColor = Color(0xFF5E3581); //Deep Purple 600
  static Color cartBadgeColor = Color(0xFFBA68C8); //purple 300

  static Color gradiendFStart = Color(0xFFE040FB); //purpleaccent
  ...
  static Color gradiendLStart = Color(0XFFAA00FF);//purpleanccent
